...
<%  List<News> list1 = (List<News>)session.getAttribute("list1");
      ...
      if(pages==null||(list1==null&&list2==null&&list3==null&&list4==null)){
    ...
    <div class="content">
      ...
      <ul class="classlist">
        <c:set value="0" var="n" />      
	      ...
	      <li><a href='util/news_control.jsp?opr=readNew&nid=${news.nid }'>${news.ntitle } </a><span> ${newsncreatedate} </span></li>
	      <c:set var="n" value="${n+1}"></c:set>
