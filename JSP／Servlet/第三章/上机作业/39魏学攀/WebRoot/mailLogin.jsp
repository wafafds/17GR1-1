...
<BODY>
<FORM NAME="myform" METHOD="POST" action="m1.jsp" onSubmit="return checkLogin()">
<TABLE align="center">
<TR>
<TD>
<IMG src="img/Snap1.jpg"><DIV style="position:absolute; left: 490px; top: 216px; width: 356px;">
                      ...
                      height=27 align=right class=bld>用户名:&nbsp;</TD>
                        ...
                        <TR vAlign=top> 
                          <TD class=bld align=right height=40>&nbsp;</TD>
                            <TD  align=left valign="middle"><A href="#"><INPUT name="submit" type="image" src="img/login.gif" width="101" height="22" border="0" ></A> </TD>
                        </TR>
          </TABLE></DIV>
</TD>
</TR>
